...
import com.example.dictionary_graphic.Main;
...
public class SecondaryController {
    ...
    public static void addNewWord(MouseEvent event) throws IOException {
        ...
        FXMLLoader fxmlLoader = new FXMLLoader(Main.class.getResource("view/add-view.fxml"));
    ...
    public static void fixWord(MouseEvent event) throws IOException {
        ...
        FXMLLoader fxmlLoader = new FXMLLoader(Main.class.getResource("view/fix-view.fxml"));
        Scene scene = new Scene(fxmlLoader.load());
        AddStage.getIcons().add(Main.logo);
    ...
    public static void deleteWord(MouseEvent event) throws IOException {
        Stage AddStage = new Stage();
        FXMLLoader fxmlLoader = new FXMLLoader(Main .class.getResource("view/delete-view.fxml"));
        Scene scene = new Scene(fxmlLoader.load());
        AddStage.getIcons().add(Main.logo);
